...
- Validation evidence: focused provider/store/API/UI/review/readiness tests pass; TypeScript check, production build, full automated suite, and `git diff --check` are required final gates for this slice.
