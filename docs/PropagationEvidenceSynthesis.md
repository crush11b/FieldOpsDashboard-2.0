...
- **Space-weather evidence**: NOAA F10.7, Kp, R-scale, GOES flare-class, and daily SESC SSN products, each retaining its own source state and timestamps. NOAA observed/predicted smoothed monthly SSN remains a separate P.533 model input.
