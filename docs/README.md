...
The V3.0-12 automated-integration evidence is [`validation/Version-3.0-12-Automated-Integration-Gate.md`](validation/Version-3.0-12-Automated-Integration-Gate.md). CF-20 update, rollback, reboot/sign-in, runtime identity, and retained-data evidence is recorded in [`validation/Version-3.0-12-CF20-Field-Acceptance.md`](validation/Version-3.0-12-CF20-Field-Acceptance.md). Final stable-release identity, artifact, publication, and accepted-deviation evidence is recorded in [`validation/Version-3.0-Release-Closure.md`](validation/Version-3.0-Release-Closure.md).
