...
Current NOAA Kp, R-scale, X-ray, and F10.7 changes and SILSO daily SSN changes do not invalidate a model result. They still affect the current evidence and final rating evaluation.
...
- `spaceWeather`: current NOAA/SILSO products plus separate NOAA model-SSN provenance
