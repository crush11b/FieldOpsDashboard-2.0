...
export const LayeredPropagationPicture: React.FC<Props> = ({ activation, brief, retained, readOnly = false }) => {
  ...
  const picture = useMemo(() => assembleLayeredPropagationPicture({ ...base, ...remote, forecast: remote.forecast ?? base.forecast, spaceWeather: remote.spaceWeather ?? base.spaceWeather }), [base, remote]);
